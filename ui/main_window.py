from PyQt5.QtWidgets import (
    QMainWindow, QWidget, QVBoxLayout, QTabWidget, QTableWidget, QTableWidgetItem,
...
class MainWindow(QMainWindow):
    def __init__(
        ...
        self.setWindowTitle("Community Golf Club Manager")
    ...
    def _populate_table(self, table, rows):
        ...
        for r, row in enumerate(rows):
            for c, col in enumerate(columns):
                table.setItem(r, c, QTableWidgetItem(str(row[col]) if row[col] is not None else ""))
    ...
    def generate_schedule(self):
        ...
        self.load_outings()
        self.refresh_assignments()
        QMessageBox.information(self, "Schedule generated", "The outing schedule has been generated.")
    ...
    def export_outputs(self):
        ...
        if not assignments:
            QMessageBox.warning(self, "No schedule", "Generate or edit a schedule first.")
            return
        pdf_path, csv_path = self.distribution_service.build_outputs(outing, tee_times, assignments)
